...
function PostCard({name,title,url,me,like,id,setupdate}){
  ...
  async function DeletePost(){
    ...
    if(sure){
         ...
         const data = await axios.delete(`https://socialmedia-backend-two.vercel.app/socialmedia/post/delete/${id}?post_url=${url}`);
  ...
  async function CommentOpen(){
    const data = await axios.get(`https://socialmedia-backend-two.vercel.app/socialmedia/post/showcomments/${id}`);
